...
**Authors:** Jorge Estiiven Burgos Ortega · Diego Navarro Gómez
...
- The Random Forest model achieves **≥ 96% accuracy** on the test set with perfect separation of *Iris-setosa* from the other two species.
